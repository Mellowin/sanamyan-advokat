...
const content = {
  ua: {
    ...
    items: [
      ...
      { icon: '💬', title: 'Зрозуміла комунікація', desc: 'Пояснюємо ситуацію зрозумілою мовою та тримаємо клієнта в курсі справи' },
  ...
  ru: {
    ...
    items: [
      ...
      { icon: '💬', title: 'Понятная коммуникация', desc: 'Объясняем ситуацию понятным языком и держим клиента в курсе дела' },
