...
const content = {
  ua: {
    ...
    services: [
      ...
      { icon: '👨‍👩‍👧', title: 'Сімейне право', desc: 'Розлучення, аліменти, поділ майна. Консультація від 1000 грн' },
  ...
  ru: {
    ...
    services: [
      ...
      { icon: '👨‍👩‍👧', title: 'Семейное право', desc: 'Развод, алименты, раздел имущества. Консультация от 1000 грн' },
